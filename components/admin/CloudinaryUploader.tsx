...
// Wrap with React.memo to prevent unnecessary re-renders when parent form data updates
export const CloudinaryUploader = React.memo(
  function CloudinaryUploaderComponent({
    value,
    onChange,
    folder = "portfolio",
    label = "Upload Image",
      ...
      <div className="space-y-3">
        ...
        >
          {({ open }) => (
            ...
            >
              <Upload
                className={`w-5 h-5 ${uploading ? "animate-spin" : ""}`}
              />
