...
import { Briefcase, Twitter, MessageCircle, Mail, Phone, CheckCircle } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://ayeshaattaria.com/contact',
    type: 'website',
  },
};
...
export default function ContactPage() {
    <div className="bg-white">
      {/* Hero Section */}
      <section className="py-12 md:py-20 bg-gradient-to-b from-white to-[#f5f5f5]">
        <div className="section-container">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-700 leading-relaxed mb-8">
              Book a <span className="font-bold text-[#4ddcd3]">FREE 15-minute consultation</span>. I&apos;ll review your attack
              surface and tell you exactly where you&apos;re exposed — before we discuss a contract.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="section-container max-w-2xl">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={idx}
                className="border-l-4 border-[#4ddcd3] pl-6 py-4"
              >
