          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-12 items-center">
            ...
            <div className="flex items-center justify-center md:justify-end relative">
              ...
              <div className="relative animate-float">
                ...
                <div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-3xl p-2 bg-white/50 backdrop-blur-sm border border-white shadow-soft-xl overflow-hidden relative z-10 group">
